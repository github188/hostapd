...
/*自定义接入原因*/
#define WLAN_REASON_ACCESS_NORMAL	1	/*第一次接入AC系统*/
#define WLAN_REASON_ACCESS_HANDOVER	2	/*切换接入*/
#define WLAN_REASON_ACCESS_AGAIN		3	/*再次接入同一VAP*/

/*自定义离线原因：高字节扩展编号*/
#define WLAN_REASON_HANDOVER					0x00010000
#define WLAN_REASON_MAC_AUTH_FAILED			0x00020000
#define WLAN_REASON_ACCESS_CONTROL			0x00030000
#define WLAN_REASON_USERDB_REGISTER_FAILED	0x00040000
