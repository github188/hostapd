...
#ifdef DEBUG_MEM
    #define os_zalloc(size)   VM_ZALLOC(size)
#else
...
#ifdef DEBUG_MEM
    #define os_malloc(size)  VM_MALLOC(size)
#else
 ...
 */
#ifdef DEBUG_MEM
    #define os_realloc(ptr, size)  VM_REALLOC(ptr, size)
#else
 ...
 */
#ifdef DEBUG_MEM
    #define os_free(ptr)    VM_FREE(ptr)
#else
...
#ifndef os_malloc
#define os_malloc(s) VM_MALLOC((s))
#endif
#ifndef os_realloc
#define os_realloc(p, s) VM_REALLOC((p), (s))
#endif
#ifndef os_free
#define os_free(p) VM_FREE((p))
#endif
...
#else
#define os_strdup(s) VM_STRDUP(s)
#endif
#endif
#ifndef os_strlen
