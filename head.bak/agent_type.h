...
/* hc add for oem 2009-11-2 */
#define OEM_MANU_BLANK										0
#define OEM_MANU_GCI											1
#define OEM_MANU_BAOFENG										2
#define OEM_MANU_JIESHENG										3
#define OEM_MANU_GBCOM										4
#define OEM_MANU_BANGXUN										5
#define OEM_MANU_DONGFANGXINLIAN								6
#define OEM_MANU_SUNWAVE            								7
#define OEM_MANU_GCI_2010										8
#define OEM_MANU_DONGFANGXINLIAN_LIANTONG					9
#define OEM_MANU_XINZHONG									10
#define OEM_MANU_HANMING										11
#define OEM_MANU_XINMIN										12


#define OEM_MANU_FLAG_ALL								"/etc/oem/* *.*"
#define OEM_MANU_FLAG_GBCOM							"/etc/oem/gbcom"
#define OEM_MANU_FLAG_GCI								"/etc/oem/jiesai"						/* 广州杰赛2009 */
#define OEM_MANU_FLAG_GCI_2010						"/etc/oem/jiesai2010"					/* 广州杰赛2010 */
#define OEM_MANU_FLAG_BAOFENG						"/etc/oem/baofeng"
#define OEM_MANU_FLAG_JIESHENG						"/etc/oem/jiesheng"
#define OEM_MANU_FLAG_BANGXUN						"/etc/oem/bangxun"
#define OEM_MANU_FLAG_DONGFANGXINLIAN				"/etc/oem/dongfangxinlian"				/*  东方信联移动*/
#define OEM_MANU_FLAG_DONGFANGXINLIAN_LIANTONG		"/etc/oem/dongfangxinlianliantong"		/* 东方信联联通*/
#define OEM_MANU_FLAG_SUNWAVE           				"/etc/oem/sunwave"

#define OEM_MANU_FLAG_XINZHONG          				"/etc/oem/xinzhong"
#define OEM_MANU_FLAG_HANMING           					"/etc/oem/hanming"					/* 汉铭*/
#define OEM_MANU_FLAG_XINMIN            					"/etc/oem/xinmin"
...
#define  sysDeviceType_N200_TA55_GN33           9003002   //单卡11gn，100mW，mimo 3×3   11n室内单频小功率接入点（100mW）
#define  sysDeviceType_N200_TA55_AGN33          9003001   //双卡11agn，500mW，mimo 3×3   11n室内双频大功率接入点（500mW）
/* add by gwx 2014-2-25 for task1265 end */
#define  sysDeviceType_N200_TA33_GN22		80101
...
typedef struct  /*简化*/
{
        unsigned long  ulRate;         /*速率值*2,如5.5M为 11 ,msc的速率也用实际速率表示,如msc1为6.5*2=13, 如此值为0xFFFFFFFF,此速率和以下速率都无统计*/
/*因对应MCS对应的不同速率，网管通过其他节点采集AP的信道带宽（20/40MHz）以及Short GI（400/800 ns）
    换算成对应具体速率,底层直接返回速率,不需网管换算了*/                                                                            
         unsigned long  ulRecvPkt;            /*ap从终端接收的包数（只含数据包）*/
         unsigned long  ulSendPkt;           /*ap发送给终端的包数（只含数据包）*/
} T_rateInfo;//modify by zjj
...
typedef struct apEndUser_s
{
	...
	/* added by laiyongxing at 2009-1-17 */
	 signed char              iSignalStrength;              /*终端当前信号强度*/  /*modify by zjj*/
	char noise;
	//end addition
	...
	/*      新增     */
	signed char              iMaxSignalStrength;              /*终端最大信号强度*/  /*modify by zjj*/
signed char              iMinSignalStrength;              /*终端最小信号强度*/  /*modify by zjj*/
...
typedef struct apEndUserSimple_s
{
	...
	/* 2011-03-23 fengjing add:最高信号强度、最低信号强度 */
	/*      新增     */
	 unsigned char iMaxSignalStrength;
	 unsigned char iMinSignalStrength;
	 unsigned short usEndUserRate;     /* 终端接入速率 */
